	...
	Geometry()
	{
		...
		ParticleEmitter("BlackSmoke")
		{
			...
			Spawner()
			{
				Spread()
				{
					PositionX(-2.1000,2.1000);
					PositionY(-2.1000,2.1000);
					PositionZ(-2.1000,2.1000);
				}
				Offset()
				{
					PositionX(-0.1050,0.1050);
					PositionY(-0.1050,0.1050);
					PositionZ(-0.1050,0.1050);
				}
				PositionScale(0.0000,0.0000);
				VelocityScale(2.8000,2.8000);
				InheritVelocityFactor(0.2000,0.2000);
				Size(0, 1.0500, 1.4700);
